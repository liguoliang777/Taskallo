...
public class SearchVideoAdapter extends BaseAdapter {
    ...
    private List<SearchGameVideoBean.DataBean.HotSearchVideoListBean> list;
    private Context context;

    public SearchVideoAdapter(Context context, List<SearchGameVideoBean.DataBean.HotSearchVideoListBean> list) {
        this.context = context;
        this.list = list;
    }

    public void setList(List<SearchGameVideoBean.DataBean.HotSearchVideoListBean> list) {
        this.list = list;
