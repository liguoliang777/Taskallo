...
public class ItemViewTouchCallback extends ItemTouchHelper.Callback {

    private RecyclerView.Adapter mAdapter;

    ItemViewTouchCallback(RecyclerView.Adapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            ...
            viewHolder.itemView.setRotation(3f);//大的item旋转
        }
