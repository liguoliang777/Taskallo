...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     * This is necessary after swipe dismissing an layout_proj_item_item. We wait until animator finishes its job
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                // can select the layout_proj_item_item
     ...
     * {@link #attachToRecyclerView(RecyclerView)}. Upon attaching, it will add an layout_proj_item_item decoration,
     ...
     * adapter (e.g. remove the layout_proj_item_item) and call related Adapter#notify event.
     */
    ...
    public abstract static class Callback {
         ...
         *
         * @param dragFlags  The directions in which the layout_proj_item_item can be dragged.
         * @param swipeFlags The directions in which the layout_proj_item_item can be swiped.
        ...
        /**
         * Called when ItemTouchHelper wants to move the dragged layout_proj_item_item from its old position to
         * the new position.
         * <p>
         ...
         * @param target       The ViewHolder over which the currently active layout_proj_item_item is being
         *                     dragged.
        ...
        /**
         * Returns whether ItemTouchHelper should start a drag and drop operation if an layout_proj_item_item is
         * long pressed.
         * <p>
         * Default value returns true but you may want to disable this if you want to start
         * dragging on a custom view touch using {@link #startDrag(RecyclerView.ViewHolder)}.
         *
         * @return True if ItemTouchHelper should start dragging an layout_proj_item_item when it is long pressed,
         ...
         *
         * @return True if ItemTouchHelper should start swiping an layout_proj_item_item when user swipes a pointer
         ...
         * @param fromPos      The previous adapter position of the dragged layout_proj_item_item (before it was
         *                     moved).
         * @param target       The ViewHolder on which the currently active layout_proj_item_item has been dropped.
         * @param toPos        The new adapter position of the dragged layout_proj_item_item.
         ...
         *                            layout_proj_item_item decorations.
     ...
     *             // move layout_proj_item_item in `fromPos` to `toPos` in adapter.
